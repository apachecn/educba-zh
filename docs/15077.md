...
| Two | Lubuntu 提供了一个精简的桌面，因为它妥协了很多以使其易于使用，另一个原因是它选择了有限的应用程序和软件包，这意味着 LXQt 是桌面的最骨架。 | 与 Lubuntu 相比，Xubuntu 并不那么精简，尽管它也比 GNOME、unity 等更轻便，因为它使用 XFCE 作为桌面环境，不会像 LXQt 那样简单。 |
