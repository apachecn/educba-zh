...
> 原文:[https://www.educba.com/unity-json/](https://www.educba.com/unity-json/)

![Unity JSON](../Images/eb6ebd6bec1238462957635a5b6e9433.png)

<noscript><img class="alignnone size-full wp-image-549501" src="../Images/eb6ebd6bec1238462957635a5b6e9433.png" alt="Unity JSON" width="900" height="500" srcset="https://cdn.educba.com/academy/wp-content/uploads/2022/08/Unity-JSON.jpg 900w, https://cdn.educba.com/academy/wp-content/uploads/2022/08/Unity-JSON-300x167.jpg 300w, https://cdn.educba.com/academy/wp-content/uploads/2022/08/Unity-JSON-768x427.jpg 768w" sizes="(max-width: 900px) 100vw, 900px" data-original-src="https://cdn.educba.com/academy/wp-content/uploads/2022/08/Unity-JSON.jpg"/></noscript>
...
当我们开始处理文件时，第一步是打开相关文件，然后处理它。完成后，关闭它以便进一步处理。因此，我们使用方法 ReadAllText()和 WriteAllText()。因此，该文件可以被读取或写入和处理，以便在内部基础上打开或关闭。
