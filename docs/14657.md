...
*   Oracle 数据库支持不同的 API 和访问方法，如 ODP.NET、JDBC、ODBC、Oracle 调用接口，而 PostgreSQL 支持 API 和其他访问方法，如 ODBC、JDBC、原生 C 库、大型对象流 API 和 ADO.NET
...
| **可扩展性** | Oracle 数据库提供了四个带标准版的插槽以实现可扩展性，但对于高工作负载项目，我们需要购买企业版，这有点贵。 | PostgreSQL 提供免费扩展的可扩展性支持，如 Skype 代理在数据库集群中分配信息，基于 PostgreSQL 的集群存储解决方案。 |
