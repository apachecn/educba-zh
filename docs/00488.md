...
> 原文:[https://www.educba.com/python-pickle-vs-json/](https://www.educba.com/python-pickle-vs-json/)

![Python-Pickle-vs-JSON](../Images/9598ed3d5f6435934a9be968f393432d.png)

<noscript><img class="alignnone size-full wp-image-308065" src="../Images/9598ed3d5f6435934a9be968f393432d.png" alt="Python-Pickle-vs-JSON" width="612" height="290" srcset="https://cdn.educba.com/academy/wp-content/uploads/2020/03/Python-Pickle-vs-JSON.jpg 612w, https://cdn.educba.com/academy/wp-content/uploads/2020/03/Python-Pickle-vs-JSON-300x142.jpg 300w" sizes="(max-width: 612px) 100vw, 612px" data-original-src="https://cdn.educba.com/academy/wp-content/uploads/2020/03/Python-Pickle-vs-JSON.jpg"/></noscript>
...
![Python-Pickle-vs-JSON-info](../Images/3ca2c50b05c21fb92fbd4ee6d9a6a239.png)

<noscript><img class="alignnone size-full wp-image-308067" src="../Images/3ca2c50b05c21fb92fbd4ee6d9a6a239.png" alt="Python-Pickle-vs-JSON-info" width="900" height="3670" srcset="https://cdn.educba.com/academy/wp-content/uploads/2020/03/Python-Pickle-vs-JSON-info.jpg 900w, https://cdn.educba.com/academy/wp-content/uploads/2020/03/Python-Pickle-vs-JSON-info-768x3132.jpg 768w, https://cdn.educba.com/academy/wp-content/uploads/2020/03/Python-Pickle-vs-JSON-info-251x1024.jpg 251w" sizes="(max-width: 900px) 100vw, 900px" data-original-src="https://cdn.educba.com/academy/wp-content/uploads/2020/03/Python-Pickle-vs-JSON-info.jpg"/></noscript>
...
保存在文件上的字节流包含了重建原始 python 对象的必要信息。将字节流转换回 python 对象的过程称为反序列化。 | JSON 代表 JavaScript 对象符号。虽然源自 JavaScript，但 JSON 是语言互操作的。JSON 是将 python 对象存储到磁盘的另一种方式，这样以后就可以加载它们，而不需要重新创建数据。 |
