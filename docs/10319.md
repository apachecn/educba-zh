...
> 原文:[https://www.educba.com/kubernetes-yaml-validator/](https://www.educba.com/kubernetes-yaml-validator/)

![Kubernetes yaml validator](../Images/2ade398061b9606e89ad70639b29df02.png)

<noscript><img class="alignnone size-full wp-image-513569" src="../Images/2ade398061b9606e89ad70639b29df02.png" alt="Kubernetes yaml validator" width="900" height="500" srcset="https://cdn.educba.com/academy/wp-content/uploads/2021/11/Kubernetes-yaml-validator.jpg 900w, https://cdn.educba.com/academy/wp-content/uploads/2021/11/Kubernetes-yaml-validator-300x167.jpg 300w, https://cdn.educba.com/academy/wp-content/uploads/2021/11/Kubernetes-yaml-validator-768x427.jpg 768w" sizes="(max-width: 900px) 100vw, 900px" data-original-src="https://cdn.educba.com/academy/wp-content/uploads/2021/11/Kubernetes-yaml-validator.jpg"/></noscript>
...
YAML 文件可以用于配置文件，也可以用于存储信息的应用程序；我们可以在任何文本编辑器中打开 YAML 文件，如果我们想编辑 YAML 文件，那么我们应该使用记事本++这样的源代码编辑器打开它，YAML 文件对用户友好，可读性好。
