...
> 原文:[https://www.educba.com/multilevel-inheritance-in-python/](https://www.educba.com/multilevel-inheritance-in-python/)

![Multilevel Inheritance in Python](../Images/21118237186a55b19cb96bf82b2a12fd.png)

<noscript><img class="alignnone size-full wp-image-339353" src="../Images/21118237186a55b19cb96bf82b2a12fd.png" alt="Multilevel Inheritance in Python" width="900" height="500" srcset="https://cdn.educba.com/academy/wp-content/uploads/2020/04/Multilevel-Inheritance-in-Python.jpg 900w, https://cdn.educba.com/academy/wp-content/uploads/2020/04/Multilevel-Inheritance-in-Python-300x167.jpg 300w, https://cdn.educba.com/academy/wp-content/uploads/2020/04/Multilevel-Inheritance-in-Python-768x427.jpg 768w" sizes="(max-width: 900px) 100vw, 900px" data-original-src="https://cdn.educba.com/academy/wp-content/uploads/2020/04/Multilevel-Inheritance-in-Python.jpg"/></noscript>
...
![Multilevel Inheritance in Python output 1](../Images/1ac0589a40cfd79a5edb739563871800.png)

<noscript><img class="alignnone size-full wp-image-338348" src="../Images/1ac0589a40cfd79a5edb739563871800.png" alt="Multilevel Inheritance in Python output 1" width="245" height="41" data-original-src="https://cdn.educba.com/academy/wp-content/uploads/2020/04/Multilevel-Inheritance-in-Python-output-1.png"/></noscript>
...
在上面使用 super()函数的多级继承示例中，我们创建了派生类 xyz2()的对象 ob，并从继承了两个类 xyz、xyz1 的类 xyz2 调用函数 sub_xyz()。在上面例子的输出中，您可以清楚地看到 python 调用类的顺序，以及它是如何解析类之间的关系的。
...
![output 2](../Images/67cffa2db25725ddb03df1d86b84503e.png)

<noscript><img class="alignnone wp-image-338349 size-full" src="../Images/67cffa2db25725ddb03df1d86b84503e.png" alt="output 2" width="316" height="154" srcset="https://cdn.educba.com/academy/wp-content/uploads/2020/04/Multilevel-Inheritance-in-Python-output-2.png 316w, https://cdn.educba.com/academy/wp-content/uploads/2020/04/Multilevel-Inheritance-in-Python-output-2-300x146.png 300w" sizes="(max-width: 316px) 100vw, 316px" data-original-src="https://cdn.educba.com/academy/wp-content/uploads/2020/04/Multilevel-Inheritance-in-Python-output-2.png"/></noscript>
